...
class ScamDetector:
    """
    Cumulative risk-based scam detector.
    Designed for demo stability and predictable activation.
    """
    ...
    def detect(self, text: str, previous_confidence: float = 0.0):
        ...
        # Apply mild decay to avoid runaway inflation
...
class ConversationAgent:
    ...
    def generate(self, session):
        ...
        # Early naive replies for first 2 turns
        if agent_turns < 2:
        ...
        try:
            ...
            timeout=60  # Increased for local CPU inference
        )
            ...
            return "I’m having trouble processing this right now."
...
def honeypot():
    ...
    # Activate once threshold crossed (never deactivate)
    ...
    return jsonify({
        ...
        "llmUsed": llm_used,
        "model": OLLAMA_MODEL if llm_used else None
    })
...
if __name__ == "__main__":
    ...
    print("Ensure Ollama is running: ollama run mistral:7b-instruct-v0.3")
