...
# ----------------------------
# Simple Scam Detector (UNCHANGED)
# ----------------------------
class ScamDetector:
    def __init__(self):
        self.patterns = [
...
"""
    ...
    # Keep max 2 sentences without breaking short replies
...
def honeypot():
    ...
    return jsonify({
        ...
        "llmUsed": llm_used,
        "model": GEMINI_MODEL if llm_used else None
    })
...
if __name__ == "__main__":
    print("Starting demo server with Gemini...")
